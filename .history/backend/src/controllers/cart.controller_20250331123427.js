...
export const deleteProducts = async (req, res) => {
    try {
        ...
        // Remove only the specific product and size
        user.cartItems = user.cartItems.filter((item) => {
            const matchCondition = item._id.toString() === productid && item.size === size;
            console.log('Item match condition:', matchCondition, 'Item:', item);
            return !matchCondition;  // Keep item if it doesn't match the condition
        });

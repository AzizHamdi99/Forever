    ...
    <div >
      <div className='flex justify-between items-center px-32 py-4 '>
       ...
       <div className='text-white cursor-pointer bg-black py-2 px-4 rounded-full' onClick={()=>navigate("/login")}>
        ...
        {cart.length>0 &&
          <p className='bg-[#c586a5] rounded-full w-[15px] h-[15px] text-[13px] text-center text-black right-32 top-10 absolute flex items-center justify-center' >{cart.length}</p>

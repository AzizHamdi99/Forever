...
<p>Add Items</p>
      ...
      <div onClick={()=>changeSelect("listitems")} className= {selected!=="listitems"? 'flex gap-3 border-[2px] border-gray-400 p-2 px-4 border-r-0 cursor-pointer':'flex gap-3 border-[1px] border-[#d5c7cd] p-2 px-4 border-r-0 cursor-pointer bg-[#fcf4f4]'}>
        <img src={assetsAdmin.order_icon} className='w-6' alt="" />
<p>List Items</p>
      </div>
      <div onClick={()=>changeSelect("orders")} className= {selected!=="orders"? 'flex gap-3 border-[2px] border-gray-400 p-2 px-4 border-r-0 cursor-pointer':'flex gap-3 border-[1px] border-[#d5c7cd] p-2 px-4 border-r-0 cursor-pointer bg-[#fcf4f4]'}>
        <img src={assetsAdmin.order_icon} className='w-6' alt="" />
<p>Orders</p>
      </div>

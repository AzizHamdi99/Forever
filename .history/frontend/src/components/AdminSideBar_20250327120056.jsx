...
<p>Add Items</p>
      ...
      <div onClick={()=>useAdminStore.getState().selected("listitems")} className= {selected!=="listitems"? 'flex gap-3 border-[1px] border-gray-400 p-2 px-4 border-r-0 cursor-pointer':'flex gap-3 border-[2px] border-[#d5c7cd] p-2 px-4 border-r-0 cursor-pointer bg-[#fcf4f4]'}>

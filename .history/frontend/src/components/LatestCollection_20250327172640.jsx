...
function LatestCollection() {
   ...
   const{prducts}=useAdminStore()
   const navigate=useNavigate()
  return (
    <div className='mt-16'>
        <div className=' text-center font-outfit'>
     <div className='text-[35px] uppercase flex gap-3 items-center justify-center '>
    <p className='text-[#707070] font-[400]'>Latest <span className='font-[600] text-[#171717]'> Collections</span></p>
...
<div className='grid grid-cols-5 mx-44 gap-5 mt-10 font-outfit'>
    {prducts.slice(0,10).map((item,index)=>{
        return(

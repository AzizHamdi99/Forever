...
function Footer() {
  return (
    <div className='mt-20'>
        ...
        <div>
            <img src={assets.logo} alt="" className='w-[166px] h-[50px] mb-10' />
        ...
        <div>
            <p className='text-[#5A5A5A] text-[22px] font-[600]'>
            COMPANY
            </p>
            <ul>
                <li>Home</li>
        ...
        <div>
            ...
            <p className='text-[#5A5A5A] text-[22px] font-[600]'>GET IN TOUCH</p>
            <ul>

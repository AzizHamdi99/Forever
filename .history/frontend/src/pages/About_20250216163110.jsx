...
function About() {
  return <div className="mx-32">
    <h1 className="text-center my-12 text-[30px] font-normal text-[#707070] uppercase">About <span className="font-semibold">Us</span></h1>
    <div className="grid grid-cols-[1fr_2fr] gap-10 text-[18px] ">
      <img src={assets.about_img} className="w-[440px]" alt="" />

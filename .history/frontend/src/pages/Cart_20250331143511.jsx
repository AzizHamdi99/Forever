...
function Cart() {
  const {cart,getCartItems,decreaseQuantity,removeFromCart,addToCart,subTotal,TVA,total}=useCartStore()
  ...
  return (
    ...
    <hr />
    <div className='text-[18px] text-[#555555] flex items-center justify-between font-bold'>
      <p>Total</p>
      <p>${total}</p>
    </div>
    <button className='text-[14px]  bg-black text-white w-1/2 py-2 uppercase items-center flex justify-end'> Proceed to checkout</button>
    </div>

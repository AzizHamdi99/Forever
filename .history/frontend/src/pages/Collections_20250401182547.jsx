...
function Collections() {
  ...
  const{searchTerm}=useAdminStore()
    ...
    <div className='flex mx-32 mt-16 gap-9'>
      ...
      <div >
        <div className='flex items-center justify-between' >
          ...
          <select name="" id="" className='p-2 border-[1px] border-[#C8C8C8] cursor-pointer' value={sortOption} onChange={(e) => setSortOption(e.target.value)}>
          <option className=' cursor-pointer' value="lowToHigh">Sort by :Price Low To High </option>
          <option className=' cursor-pointer' value="highToLow">Sort by :Price Hight To Low </option>

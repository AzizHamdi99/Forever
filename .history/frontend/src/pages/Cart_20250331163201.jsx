...
function Cart() {
  ...
  return (
    ...
    <button onClick={()=>navigate('/delivery')} className='text-[14px] ml-auto mt-2 font-[500]  bg-black text-white w-1/2 py-3 uppercase items-center '> Proceed to checkout</button>
    </div>

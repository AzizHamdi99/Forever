...
function Details() {
  ...
  //const [mainPic,setMainPic]=useState(product.image[0])
  //console.log(mainPic)
//console.log(product)
  ...
  return (
    ...
    <div className='mt-10 mx-32'>
      <div className='flex gap-4 '>
        ...
        <div className='ml-2'>
          <p className='text-[34px] font-[500] text-[#3D3D3D] mb-2'>{product.name}</p>
          ...
          <p className='text-[32px] text-[#2A2A2A] font-[500] '>${product.price}</p>
          <p className='text-[#555555] text-[16px] font-[400] my-6'>{product.description}</p>

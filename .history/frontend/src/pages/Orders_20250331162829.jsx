...
function Orders() {
  ...
  return (
    <div className='mx-32'>
      <div className="flex gap-2  items-center justify-start mt-12 ">
...
<div className='flex items-center justify-between'>
    ...
    <h1 className=" my-3 text-[22px] font-[600] text-[#707070] uppercase">Cart <span className="font-[600] text-[#171717]">Totals</span></h1>
    <div className="h-[2px] bg-black w-10">

...
function Login() {
  ...
  return (
    ...
    <div className='flex justify-center items-center flex-col '>
        <input onChange={()=>setData(email:e.target.value)} className='border-[1px] border-black  w-[420px] px-5 py-2 mb-4 text-[#6A6A6A] text-[18px] ' type="email" placeholder='Email' />

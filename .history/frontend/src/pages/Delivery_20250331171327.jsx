...
<div className='flex justify-between mt-5'>
  <div className=' flex flex-col gap-4 '>
    <div className='flex items-center gap-4'>
      <input type="text" onChange={()=>setInfo({...info,firstName:e.target.value})} placeholder='First name' className='h-[50px] border-[1px] border-[#C5C5C5] px-3 rounded-[4px] text-[#8B8B8B] text-[18px]' />

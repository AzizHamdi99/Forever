...
function Login() {
  ...
  return (
    ...
    <div className='flex justify-center items-center flex-col '>
        <input onChange={()=>setData(...data,email:e.target.value)} className='border-[1px] border-black  w-[420px] px-5 py-2 mb-4 text-[#6A6A6A] text-[18px] ' type="email" placeholder='Email' />
        ...
        <div className='flex gap-40 mt-2 text-[#3C3C3C] text-[16px] font-[400]'>
            ...
            <p className=' cursor-pointer' onClick={()=>navigate("/signup")}>Create accout </p>
        </div>
        <button className='bg-black text-white py-3 px-10 mt-7'>Sign in</button>
    </div>

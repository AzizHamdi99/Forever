...
export const useAdminStore = create((set, get) => ({
    ...
    getSingleProduct: async (id) => {
        try {
            ...
            set((state) => {
                console.log("Previous Zustand state:", state.singleProduct); // Log before update
                const updatedState = { ...state, singleProduct: res.data };
                console.log("Updated Zustand state:", updatedState.singleProduct); // Log after update
                return updatedState;
            });

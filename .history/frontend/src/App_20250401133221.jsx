      ...
      <Toaster
        position="top-right"   toastOptions={{
          ...
          style: {
            ...
            boxShadow: '0 2px 6px rgba(0, 0, 0, 0.2)', // Adding some shadow to make it stand out
            marginTop: '20px', // Adding top margin to create space between the top and the toast
          }}/>
